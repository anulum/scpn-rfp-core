...
# SCPN RFP Core — repository-level truth tests
...
REQUIRED_PATHS = (
    ...
    "src/scpn_rfp_core/geometry/__init__.py",
    "src/scpn_rfp_core/geometry/device.py",
    "src/scpn_rfp_core/geometry/model.py",
    "src/scpn_rfp_core/geometry/cad.py",
    "src/scpn_rfp_core/geometry/export.py",
    ...
    "rust/pyproject.toml",
    "rust/src/lib.rs",
    "rust/src/relaxation.rs",
    "rust/src/profiles.rs",
    "src/scpn_rfp_core/physics/__init__.py",
    "src/scpn_rfp_core/physics/numerics.py",
    "src/scpn_rfp_core/physics/relaxation.py",
    "src/scpn_rfp_core/physics/profiles.py",
    "src/scpn_rfp_core/physics/level0.py",
    "reactor-domain.json",
    "requirements-dev.txt",
    "src/scpn_rfp_core/__init__.py",
    "src/scpn_rfp_core/configuration.py",
    "src/scpn_rfp_core/errors.py",
    "src/scpn_rfp_core/observability.py",
    "src/scpn_rfp_core/plan_envelope.py",
    "tests/data/plan_envelope_fixture.json",
    "src/scpn_rfp_core/parameters.py",
...
def test_manifest_declares_exact_configuration_assignment() -> None:
    ...
    assert manifest["project"] == "SCPN-RFP-CORE"
...
def test_package_agrees_with_manifest_truth() -> None:
    ...
    from scpn_rfp_core import OWNED_CONFIGURATIONS, RegistryBinding
...
def test_typed_package_marker_exists() -> None:
    ...
    assert (REPO / "src" / "scpn_rfp_core" / "py.typed").is_file()
