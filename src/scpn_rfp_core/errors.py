...
# SCPN RFP Core — device capability model errors
...
class NumericsError(DeviceConfigurationError):
    ...
    argument outside its declared domain or non-finite; this error
    re-raises that refusal under the device error type with the library's
    message.
    """
