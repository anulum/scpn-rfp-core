...
# SCPN RFP Core — device CAD model benchmark
...
synthetic four-body device assembly: building the B-rep bodies with the
...
from scpn_rfp_core.geometry import DeviceGeometry  # noqa: E402
...
SCHEMA: Final = "scpn-rfp-core.device-model-cad-benchmark.v1"
...
def operations() -> list[tuple[str, Callable[[], float]]]:
    ...
    from scpn_rfp_core.geometry import build_device_cad
